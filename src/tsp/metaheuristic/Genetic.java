...
public class Genetic extends TSPSolver{
	...
	public void getInitGene() throws Exception {
		...
		/**
		 * 
		 * @return une liste de nbIndividus solutions identique a m_solution
		 */
		...
		/**
		 * Effectue une mutation pour les n parents et garde les n meilleurs parmis les parents et les descendant
		 * La mutation consiste en un simple swap entre la place de 2 villes 
		 * @param parents
		 * la liste de solution de la generation actuelle
		 * @return une liste de solution de la generation future
		 * @throws Exception
		 */
